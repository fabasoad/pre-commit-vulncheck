...
CONFIG_LOG_HEADER_DEFAULT_VAL="${_PRE_COMMIT_VULNCHECK_APP_NAME}"
CONFIG_LOG_DATE_FORMAT_DEFAULT_VAL="%Y-%m-%d %T"
CONFIG_LOG_OUTPUT_FORMAT_DEFAULT_VAL="text"

# Vulncheck
CONFIG_VULNCHECK_VERSION_ARG_NAME="--vulncheck-version"
CONFIG_VULNCHECK_VERSION_DEFAULT_VAL="latest"
...
CONFIG_CACHE_ROOT_DIR="${_PRE_COMMIT_VULNCHECK_CONSUMER_ROOT_DIR}/${CONFIG_CACHE_ROOT_DIR_NAME}"
CONFIG_CACHE_APP_DIR_NAME="${_PRE_COMMIT_VULNCHECK_APP_NAME}"
